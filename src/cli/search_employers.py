...
def run():
    """
    Метод для запуска поиска работодателей по запросу пользователя,
    который возвращает информацию о работодателях подходящих под запрос
    """
    ...
    table = PrettyTable(
        field_names=['ID компании', 'Название компании', 'Ссылка на компанию', 'Кол-во вакансий компании']
    )
    table.sortby = 'Кол-во вакансий компании'
